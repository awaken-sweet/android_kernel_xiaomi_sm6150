...
export PATH="/home/zohaib/aosp/prebuilts/clang/host/linux-x86/clang-r596125/bin/:$PATH"
...
if [ -d "$AK3_DIR" ]; then
	...
	if ! git clone -q https://github.com/lemezohaib/AnyKernel3 -b master AnyKernel3; then
